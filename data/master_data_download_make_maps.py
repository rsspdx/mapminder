...
# maternal mortality rate per 100000 live births
    {'name' : 'maternal_mortality_rate',
     ...
     'long_name' : 'Maternal Mortality Rate: maternal deaths per 100,000 live births, 2015',
     'source' : 'World Bank, World Development Indicators',
...
{'varname': 'ease_doing_business_resid', 'long_name': 'Ease of Doing Business (Ranking, 1 = Easiest), Residuals from Regression on GDP per Capita', 'short_name': 'Ease of Doing Business (Ranking), Residuals', 'source':'World Bank, World Development Indicators'},
{'varname': 'ease_doing_business', 'long_name': 'Ease of Doing Business (Ranking, 1 = Easiest), 2018', 'short_name': 'Ease of Doing Business (Ranking)', 'source':'World Bank, World Development Indicators'},
...
{'varname': 'literacy_rate_resid', 'long_name': 'Literacy Rate (% of Adults over 15, Residuals from Regression on GDP per Capita', 'short_name': 'Literacy Rate, Residuals', 'source': 'World Bank, World Development Indicators'},
{'varname': 'literacy_rate', 'long_name': 'Literacy Rate (% of Adults over 15 Who Can Read and Write)', 'short_name': 'Literacy Rate', 'source': 'World Bank, World Development Indicators'},
...
{'varname': 'maternal_mortality_rate', 'long_name': 'Maternal Mortality Rate, (deaths per 100,000 live births), 2015', 'short_name': 'Maternal Mortality Rate', 'source':'World Bank, World Development Indicators'},
...
{'varname': 'mobile_phone_subscriptions_pct_pop_resid', 'long_name': 'Mobile Phone Subscriptions, % of Population, Residuals from Regression on GDP per Capita', 'short_name': 'Mobile Phone Subscriptions, Residuals', 'source':'World Bank, World Development Indicators'},
...
{'varname': 'mortality_under_5_per_1000_live_births', 'long_name': 'Mortality Under 5 Years, per 1000 Live Births, 2015', 'short_name': 'Mortality Under 5 Years', 'source':'World Bank, World Development Indicators'},
{'varname': 'net_lending_borrowing_pct_gdp_resid', 'long_name': 'Net Lending/Borrowing, % of Gross Domestic Product, Residuals from Regression on GDP per Capita', 'short_name': 'Net Lending/Borrowing, Residuals', 'source':'World Bank, World Development Indicators'},
...
{'varname': 'oda_pct_of_gni_resid', 'long_name': 'Official Development Assistance, & of Gross National Income, Residuals from Regression on GDP per Capita', 'short_name': 'Official Development Assistance, Residuals', 'source':'World Bank, World Development Indicators'},
...
{'varname': 'ti_cpi_resid', 'long_name': 'Corruption Perception Index (0 - 100, 0 = Most Corrupt), Residuals from Regression on GDP per Capita', 'short_name': 'Corruption Perception Index (reversed), residuals', 'source':'Transparency International'},
{'varname': 'ti_cpi', 'long_name': 'Corruption Perception Index (0 - 100, 0 = Most Corrupt), 2015', 'short_name': 'Corruption Perception Index (reversed)', 'source':'Transparency International'},
